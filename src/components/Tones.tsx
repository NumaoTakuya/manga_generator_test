...
const HorizontalGradient = (colors: string[], size: Size) => (
  <svg width={size.width} height={size.height}>
    ...
    <rect x="0" y="0" width={size.width} height={size.height} fill="url(#Gradient1)" />
  </svg>
);
...
const VerticalGradient = (colors: string[], size: Size) => (
  <svg width={size.width} height={size.height}>
    ...
    <rect x="0" y="0" width={size.width} height={size.height} fill="url(#Gradient1)" transform="rotate(90, 100, 100)" />
  </svg>
);
...
const RadialGradient = (colors: string[], size: Size) => (
  <svg width={size.width} height={size.height}>
    ...
    <rect x="0" y="0" width={size.width} height={size.height} fill="url(#RadialGradient1)" />
  </svg>
);
...
const PolkaDots = (color: string, size: Size) => (
  <svg width={size.width} height={size.height}>
    ...
    <rect x="0" y="0" width={size.width} height={size.height} fill="url(#PolkaDots)" />
  </svg>
);
...
const Checkerboard = (color: string, size: Size) => (
  <svg width={size.width} height={size.height}>
    ...
    <rect x="0" y="0" width={size.width} height={size.height} fill="url(#Checkerboard)" />
  </svg>
);
...
const DiagonalLines = (color: string, size: Size) => (
  <svg width={size.width} height={size.height}>
    ...
    <rect x="0" y="0" width={size.width} height={size.height} fill="url(#DiagonalLines)" />
  </svg>
);
...
const Crosshatch = (color: string, size: Size) => (
  <svg width={size.width} height={size.height}>
    ...
    <rect x="0" y="0" width={size.width} height={size.height} fill="url(#Crosshatch)" />
  </svg>
);
...
const HorizontalStripes = (color: string, size: Size) => (
  <svg width={size.width} height={size.height}>
    {/* Horizontal Stripes */}
    <defs>
      <pattern id="HorizontalStripes" x="0" y="0" width={size.width} height="20" patternUnits="userSpaceOnUse">
        <rect x="0" y="0" width={size.width} height="10" fill={color} />
      </pattern>
    </defs>
    <rect x="0" y="0" width={size.width} height={size.height} fill="url(#HorizontalStripes)" />
  </svg>
);
...
const VerticalStripes = (color: string, size: Size) => (
  <svg width={size.width} height={size.height}>
    {/* Vertical Stripes */}
    <defs>
      <pattern id="VerticalStripes" x="0" y="0" width="20" height={size.height} patternUnits="userSpaceOnUse">
        <rect x="0" y="0" width="10" height={size.height} fill={color} />
      </pattern>
    </defs>
    <rect x="0" y="0" width={size.width} height={size.height} fill="url(#VerticalStripes)" />
  </svg>
);
  ...
  <svg width={size.width} height={size.height}>
    ...
    <defs>
      <pattern id="Stars" x="0" y="0" width="50" height="50" patternUnits="userSpaceOnUse">
        <polygon points="25,5 32,20 50,20 35,30 40,47 25,35 10,47 15,30 0,20 18,20" fill={color} />
      </pattern>
    </defs>
    <rect x="0" y="0" width={size.width} height={size.height} fill="url(#Stars)" />
  </svg>
);
